...
namespace BethanysPieShopHRM.ClientOIDC.Services
{
    ...
    public class OpenIDConnectService : IOpenIDConnectService
    {
        ...
        public OpenIDConnectService(HttpClient httpClient, string clientId, string responseType, string scopes, string redirectUri, string postLogoutRedirectUri, string clientSecret = null)
        {
        ...
        public async Task<(string AuthorizeUrl, string CodeVerifier)> CreateAuthorizeUrlAsync()
        {
            await LoadEndpointsAsync();
        ...
        public async Task<string> CreateLogoutUrlAsync(string idTokenHint)
        {
            await LoadEndpointsAsync();
        ...
        public async Task<(string AccessToken, string IdentityToken, DateTime Expiry)> GetApiAccessTokenAsync(string code, string codeVerifier)
        {
            await LoadEndpointsAsync();
